...
INSERT OR IGNORE INTO FileTag (FileId, TagId) VALUES ();

INSERT OR IGNORE INTO FileHash (FileId, HashId) VALUES (); 

INSERT OR IGNORE INTO Transcription (FileId, AudioTranscriptId) VALUES ();
INSERT OR IGNORE INTO Transcription (FileId, AudioTranscriptId) VALUES ();

INSERT OR IGNORE INTO LocalConfig (LocalConfigKey, LocalConfigValue) VALUES ();   